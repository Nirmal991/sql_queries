...
INSERT INTO employees1 (employee_id, first_name, last_name, email, hire_date, salary, department_id)
VALUES
...
CREATE TABLE employee_skills (
    ...
    CONSTRAINT fk_employee_skill FOREIGN KEY (employee_id) REFERENCES employees1(employee_id)
);
